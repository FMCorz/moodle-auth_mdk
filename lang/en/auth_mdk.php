...
$string['bothfirstandlastname'] = 'Both first and last names';
...
$string['prefixboth'] = 'Prefix of both first and last names';
$string['prefixfirstname'] = 'Prefix of the first name';
$string['prefixlastname'] = 'Prefix of the last name';
$string['suffixboth'] = 'Suffix of both first and last names';
$string['suffixfirstname'] = 'Suffix of the first name';
$string['suffixlastname'] = 'Suffix of the last name';
$string['useusernameas'] = 'Use username as';
$string['useusernameashelp'] = 'User this setting to force the username to be part of the user first and/or last names.';
